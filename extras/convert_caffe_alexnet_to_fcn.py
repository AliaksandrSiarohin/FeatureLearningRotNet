...
if __name__ == '__main__':
    ...
    parser.add_argument('--src', type=str, required=True, default='',
                        help='Source location of the Alexnet model params saved in caffe format')
    parser.add_argument('--dst', type=str, required=True, default='',
                        help='Destination location where the Alexnet-fcn model params will be saved in caffe format')
