...
CUDA_VISIBLE_DEVICES=1 python main.py --exp=CIFAR10_GroupRotNet_NIN4blocks
...
CUDA_VISIBLE_DEVICES=1 python main.py --exp=CIFAR10_MultLayerClassifier_on_GroupRotNet_NIN4blocks_Conv2_feats
